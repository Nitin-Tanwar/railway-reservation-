$(document).ready(function(){
    ...
    btn.click(function(){
        if(inp.val()==""){
            ...
            $.ajax({
                url:`https://api.railwayapi.com/v2/pnr-status/pnr/${inp.val()}/apikey/38hez2h9jp/`,
                method:'GET',
    ...
    $('#nobtn').click(function(){
        if(inp2.val()==""){
            ...
            $.ajax({
                url:`https://api.railwayapi.com/v2/name-number/train/${inp2.val()}/apikey/38hez2h9jp/`,
                method:'GET',
                // data:{pnr:inp.val(),apikey:r5jc1q46rj},
                success:function(data) {
                    //data["total_passengers should be used for the for loop for finding for how many time loops need to be runned"]
    ...
    $('#tbtn').click(function(){
        if(inp3.val()==""){
            ...
            $.ajax({
                url:`https://api.railwayapi.com/v2/between/source/${inp3.val()}/dest/${inp31.val()}/date/${inp32.val()}/apikey/38hez2h9jp/`,
                method:'GET',
                // data:{pnr:inp.val(),apikey:r5jc1q46rj},
                success:function(data) {
                    //data["total_passengers should be used for the for loop for finding for how many time loops need to be runned"]
    ...
    $('#cancelbtn').click(function(){
        if(inp4.val()==""){
          alert('input cannot be left blank')
            ...
            $.ajax({
                url:`https://api.railwayapi.com/v2/cancelled/date/${inp4.val()}/apikey/38hez2h9jp/`,
                method:'GET',
                // data:{pnr:inp.val(),apikey:r5jc1q46rj},
                success:function(data) {
                    //data["total_passengers should be used for the for loop for finding for how many time loops need to be runned"]
    ...
    $('#rebtn').click(function(){
        if(inp5.val()==""){
            ...
            $.ajax({
                url:`https://api.railwayapi.com/v2/rescheduled/date/${inp5.val()}/apikey/38hez2h9jp/`,
                method:'GET',
                // data:{pnr:inp.val(),apikey:r5jc1q46rj},
                success:function(data) {
                    //data["total_passengers should be used for the for loop for finding for how many time loops need to be runned"]
